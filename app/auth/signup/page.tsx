...
export const metadata = { title: 'Create Account — M7 Tire Shop' };
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <Link href="/" className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="font-black text-xl tracking-tight text-on-surface">
              M7 <span className="text-tertiary">TIRE SHOP</span>
            </span>
          </Link>
          <h1 className="text-3xl font-bold text-on-surface mb-2">Create Account</h1>
          <p className="text-on-surface-variant text-sm">Start managing your car services</p>
        </div>
        <div className="glass-card p-8 rounded-2xl">
          ...
          <p className="text-center text-on-surface-variant text-sm mt-6">
            ...
            <Link href="/auth/login" className="text-tertiary font-semibold hover:underline">
              Sign in
            </Link>
          </p>
        </div>
        <p className="text-center mt-6">
          <Link href="/" className="text-on-surface-variant text-sm hover:text-tertiary transition-colors">
            ← Back to home
          </Link>
        </p>
      </div>
